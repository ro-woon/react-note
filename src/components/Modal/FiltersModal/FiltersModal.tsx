...
interface FiltersModalProps { //ts를 위한 interface 생성
  handleFilter: (e: React.ChangeEvent<HTMLInputElement>) => void;
  handleClear: () => void;
  filter: string;
}

// 여기서 필터를 사용하고, 로직 구현은 다른 곳에서 진행한다.
const FiltersModal = ({ handleFilter, handleClear, filter }: FiltersModalProps) => { // props의 타입 지정
